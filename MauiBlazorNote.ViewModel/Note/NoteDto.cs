namespace MauiBlazorNote.ViewModel.Note
{
    ...
    {
        public Data.Entity.NoteEntity Map(NoteViewModel viewModel)
        {
        ...
        public NoteViewModel Map(Data.Entity.NoteEntity dataEntity)
        {
        ...
        public IEnumerable<NoteViewModel> Map(IEnumerable<Data.Entity.NoteEntity> dataEntityList)
        {
